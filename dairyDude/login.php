    ...
    <?php
        if($validUser == true || isset($_SESSION['validUser'])){
            ...
            <div class="list-group ">
                ...
                <a class="list-group-item list-group-item-action" href="deleteProduct.php">Select products to update<span class="badge"><i class="fa-solid fa-pen-to-square"></i></span></a>
