...
<head>
    ...
    <script>
        ...
        function UpDateProduct(productId){
            ...
            let getUser = document.querySelector("#userInput").value;
            let confReply = confirm("Are you sure that you want to Update this product?");
            if(getUser == ""){
                if(confReply){
                window.location.replace("updateProduct.php?merchId=" +productId);
             }else{
                window.location.replace("deleteProduct.php");
            }
            }else{
        ...
        ?>
            <div class="merchBlock">
                <div class="merchImage">
                    ...
                    <button class="updateButton" onclick="UpDateProduct( <?php echo $result['merch_id'];?>)">Update</button>
                    </div>                                                                                                            
                <?php
                }       //end of foreach
                ?>
